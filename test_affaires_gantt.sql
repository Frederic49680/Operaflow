...
-- ============================================
-- 6. Test : Déclarer la planification
-- ============================================
...
BEGIN
    ...
    IF v_affaire_id IS NOT NULL THEN
        -- Utiliser des dates courtes pour éviter les conflits avec le trigger
...
-- ============================================
-- 7. Test : Vérifier la complétion d'un jalon
-- ============================================
