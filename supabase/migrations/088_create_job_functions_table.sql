-- Migration 088: Création de la table des fonctions de l'entreprise (distincte des rôles applicatifs)
-- Objectif: Séparer les "rôles app" (droits) des "fonctions métier" (hiérarchie)

-- Table des fonctions de l'entreprise (remplace la confusion avec roles)
...
-- Table de liaison ressources -> fonctions (remplace resource_roles)
...
-- Insertion des fonctions de base de l'entreprise
...
-- Commentaires
COMMENT ON TABLE job_functions IS 'Fonctions hiérarchiques de l''entreprise (distinctes des rôles applicatifs)';
