-- Migration 037 : Correction du trigger pour autoriser les tâches parapluies à dépasser la fin prévue
-- Date : 20/10/2025
-- Description : Modifie le trigger pour permettre aux tâches parapluies de dépasser la fin prévue de l'affaire
