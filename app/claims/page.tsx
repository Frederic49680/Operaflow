...
import { AlertTriangle, Plus, Search, Download, Filter, DollarSign } from "lucide-react"
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-12 h-12 bg-gradient-to-br from-red-500 to-red-600 rounded-lg flex items-center justify-center shadow-md shadow-red-500/30">
            ...
            <div>
              ...
              <p className="text-slate-600">Gestion des réclamations internes et clients</p>
            </div>
          </div>
        </div>
        ...
        <Card className="border-slate-200 shadow-md">
          <CardHeader>
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div>
                <CardTitle className="text-slate-800">Liste des réclamations</CardTitle>
                <CardDescription>
