-- ============================================
-- INSTALLATION: Fonction de désactivation complète
-- ============================================
-- Date: 2025-01-20
-- Objectif: Désactiver une ressource, retirer ses affectations et créer des alertes
-- ============================================
...
-- TEST DE LA FONCTION
-- ============================================
-- Pour tester la fonction, exécutez :
...
WHERE routine_schema = 'public'
  AND routine_name = 'fn_desactiver_ressource';
